...
void misc::OnCreateMove(CInput::CUserCmd *cmd, C_BaseEntity *local)
{
    ...
    if(g_Options.Misc.syncclantag)
    {
        if (int(g_Globals->curtime) != iLastTime)
        {
            ...
            {
            case 0: setclantag(XorStr("Machoware      ")); break;
            case 1: setclantag(XorStr("Machowar       ")); break;
            case 2: setclantag(XorStr("Machowa        ")); break;
            case 3: setclantag(XorStr("Machow         ")); break;
            case 4: setclantag(XorStr("Macho          ")); break;
            case 5: setclantag(XorStr("Mach           ")); break;
            case 6: setclantag(XorStr("Mac            ")); break;
            case 7: setclantag(XorStr("Ma             ")); break;
            case 8: setclantag(XorStr("M              ")); break;
            case 9: setclantag(XorStr("              M")); break;
           case 10: setclantag(XorStr("             Ma")); break;
           case 11: setclantag(XorStr("           Mach")); break;
           case 12: setclantag(XorStr("          Macho")); break;
           case 13: setclantag(XorStr("         Machow")); break;
           case 14: setclantag(XorStr("        Machowa")); break;
           case 15: setclantag(XorStr("      Machoware")); break;
           case 16: setclantag(XorStr("     BUY ME    ")); break;
           case 17: setclantag(XorStr("   Just Kidding")); break;
           case 18: setclantag(XorStr("Machoware      ")); break;
           case 19: setclantag(XorStr("Try me bitch   ")); break;
            }
        }
